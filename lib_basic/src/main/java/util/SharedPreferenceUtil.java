...
//     * @return
//     */
//    public <T> T getmModel(String key, TypeToken<T> typeToken) {
//        Gson g = new Gson();
//        T t = null;
//        String value = null;
//        if (!TextUtils.isEmpty(key)) {
...
//
//        try {
//            t = g.fromJson(value, typeToken.getmType());
...
//     * @return
//     */
//    public <T> List<T> getModels(String key, TypeToken<List<T>> typeToken) {
//        List<T> bean;
//        Gson g = new Gson();
//        T t = null;
//        String value = null;
...
//        }
//
//        bean = g.fromJson(value, typeToken.getmType());
//        return bean;
//    }
